  ...
  constructor() {
    ...
    this.state = {
      movies: [
        ...
        { _id: 3, Title: 'Gladiator', Descrpition: 'A former Roman General sets out to exact vengeance against the corrupt emperor who murdered his family and sent him into slavery.', ImagePath: 'https://upload.wikimedia.org/wikipedia/en/f/fb/Gladiator_%282000_film_poster%29.png', Genre: 'Drama', Director: "Ridley Scott" }
      ],
      selectedMovie: null
    }
  }
